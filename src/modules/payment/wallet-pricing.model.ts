...
export const DEFAULT_WALLET_COIN_PACKAGES: IWalletCoinPack[] = [
  // No pack below MIN_COINS_TO_CALL (450) so a single recharge can start a paid call.
  { coins: 550, tier1PriceInr: 499, tier2PriceInr: 499, oldPriceInr: 999, isActive: true, sortOrder: 1 },
  { coins: 850, tier1PriceInr: 799, tier2PriceInr: 799, oldPriceInr: 1599, isActive: true, sortOrder: 2 },
  { coins: 1400, tier1PriceInr: 999, tier2PriceInr: 999, oldPriceInr: 1999, isActive: true, sortOrder: 3 },
  { coins: 3500, tier1PriceInr: 2099, tier2PriceInr: 2099, oldPriceInr: 4199, isActive: true, sortOrder: 4 },
  { coins: 7500, tier1PriceInr: 3999, tier2PriceInr: 3999, oldPriceInr: 7999, isActive: true, sortOrder: 5 },
  { coins: 11500, tier1PriceInr: 7999, tier2PriceInr: 7999, oldPriceInr: 15999, isActive: true, sortOrder: 6 },
];
